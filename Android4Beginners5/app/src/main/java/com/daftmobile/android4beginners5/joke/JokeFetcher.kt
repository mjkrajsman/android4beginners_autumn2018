        ...
        call.enqueue(object : Callback<ResponseBody> {
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if(response.isSuccessful) {
                    onSuccess(response.body()?.string() ?: return onError("Weird empty response"))
                }else{
...
//        val body = response.body()?.string() ?: return onError("Nic nie zwróciłem")
//        onSuccess(body)
    }
}
